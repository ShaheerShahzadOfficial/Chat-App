        ...
        <div className="bg-[#272727] grid grid-rows-[1fr,14fr] divide-y divide-[#1c1c1c]">
           ...
           {/* Input */}
            ...
            <div className="flex h-14 justify-center items-center  ">
                <input onChange={(e)=>onChange(e)} type="text" placeholder="Search User" className="my-5 text-zinc-50 h-[70%] w-[90%] p-2 outline-none rounded bg-[#2f2f2f]" />
            </div>
...
{
    Contact?.map((item,i)=>(
        <div key={i} className={'transition duration-700 my-1 border-b border-[#2f2f2f] flex items-center gap-2 cursor-pointer h-14 py-1.5 '}>
